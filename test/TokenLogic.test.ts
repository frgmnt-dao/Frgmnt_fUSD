...
describe('TokenLogic (FUSD)', () => {
  async function deployFixture() {
    ...
    const fusd = await upgrades.deployProxy(
      TokenLogic,
      [adminAddress, emergencyAddress, poolLogicAddress, poolMgrAddress, cooldown, 'Frgmnt USD', 'fUSD'],
  ...
  it('rejects zero-valued initializer dependencies', async () => {
    ...
    await expect(
      upgrades.deployProxy(
        TokenLogic,
        [ethers.ZeroAddress, emergencyAddress, poolLogicAddress, poolMgrAddress, cooldown, 'Frgmnt USD', 'fUSD'],
        { initializer: 'initialize', kind: 'uups' },
      ),
    ...
    await expect(
      upgrades.deployProxy(
        TokenLogic,
        [adminAddress, ethers.ZeroAddress, poolLogicAddress, poolMgrAddress, cooldown, 'Frgmnt USD', 'fUSD'],
        { initializer: 'initialize', kind: 'uups' },
      ),
    ...
    await expect(
      upgrades.deployProxy(
        TokenLogic,
        [adminAddress, emergencyAddress, poolLogicAddress, ethers.ZeroAddress, cooldown, 'Frgmnt USD', 'fUSD'],
        { initializer: 'initialize', kind: 'uups' },
      ),
    ...
    await expect(
      upgrades.deployProxy(
        TokenLogic,
        [adminAddress, emergencyAddress, poolLogicAddress, poolMgrAddress, cooldown, '', 'fUSD'],
        { initializer: 'initialize', kind: 'uups' },
      ),
    ...
    await expect(
      upgrades.deployProxy(
        TokenLogic,
        [adminAddress, emergencyAddress, poolLogicAddress, poolMgrAddress, cooldown, 'Frgmnt USD', ''],
        { initializer: 'initialize', kind: 'uups' },
      ),
  ...
  it('accepts a zero _poolLogic at initialize (FNA-09: deliberate — deployment-ordering, wired up later via setPoolLogic)', async () => {
    ...
    const fusd = await upgrades.deployProxy(
      TokenLogic,
      [adminAddress, emergencyAddress, ethers.ZeroAddress, poolMgrAddress, cooldown, 'Frgmnt USD', 'fUSD'],
      { initializer: 'initialize', kind: 'uups' },
    );
