...
describe('TestUniswapV3AssetGuardStubbed', () => {
  async function deployFixture() {
    ...
    // ------------------------------------------------------------------
    const MockUniV3PositionManagerExtended = await ethers.getContractFactory(
      'MockUniV3PositionManagerExtended',
    );
    ...
    // ------------------------------------------------------------------
    const MockUniswapV3PositionGuard = await ethers.getContractFactory(
      'MockUniswapV3PositionGuard',
    );
    ...
    // ------------------------------------------------------------------
    const TestUniswapV3AssetGuardStubbed = await ethers.getContractFactory(
      'TestUniswapV3AssetGuardStubbed',
    );
