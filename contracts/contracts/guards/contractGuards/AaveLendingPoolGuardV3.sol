    ...
    returns (uint16 txType, bool isPublic)
  {
     ...
     */
      ...
      (address asset, bool useAsCollateral) =
        abi.decode(getParams(data), (address, bool));
     ...
     */
      ...
      (address borrowAsset, uint256 amount, uint256 interestRateMode, , address onBehalfOf) =
     ...
     */
      ...
      (address asset, uint256 rateMode) =
        abi.decode(getParams(data), (address, uint256));
     ...
     */
      ...
      (address asset, address user) =
        abi.decode(getParams(data), (address, address));
