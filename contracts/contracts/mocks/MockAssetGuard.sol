...
contract MockAssetGuard {
  ...
  constructor(uint256 _dec) { dec = _dec; }

  // PoolManagerLogic checks for this via low-level call
  function isAddAssetCheckGuard() external pure returns (bool) { return true; }
  ...
  function getBalance(address /*poolLogic*/, address /*asset*/) external pure returns (uint256) { return 0; }
  function getDecimals(address /*asset*/) external view returns (uint256) { return dec; }
