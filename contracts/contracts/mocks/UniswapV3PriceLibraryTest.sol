...
contract UniswapV3PriceLibraryTest {
	...
	function assertFairPriceWithFactory(
		...
		return UniswapV3PriceLibrary.assertFairPrice(dhedgeFactory, uniswapV3Factory, token0, token1, fee);
	}
	...
	function calculateSqrtPriceWrapper(
		...
		return UniswapV3PriceLibrary.calculateSqrtPrice(token0Price, token1Price, token0Decimals, token1Decimals);
	}
}
