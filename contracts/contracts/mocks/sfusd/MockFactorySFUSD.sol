...
contract MockFactorySFUSD {
    ...
    function pausedPools(address) external pure returns (bool) {
        return false;
    }
    function tradingPausedPools(address) external pure returns (bool) {
        return false;
    }

    // ---- IPoolFactory bits ----
    function receiverWhitelist(address) external pure returns (bool) {
        return false;
    }
    function governanceAddress() external pure returns (address) {
        return address(0);
    }
    ...
    // ---- IHasGuardInfo ----
    function getContractGuard(address) external pure returns (address) {
        return address(0);
    }
    ...
    // ---- IHasFeeInfo ----
    function getExitCooldown() external pure returns (uint256) {
        return 0;
    }
}
