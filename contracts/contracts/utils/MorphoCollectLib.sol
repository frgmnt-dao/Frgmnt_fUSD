  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function collectDebts(
        ...
        for (uint256 i; i < mids.length; i++) {
            ...
            uint256 repayShares = MorphoMathLib.mulPortionRoundUp(p.borrowShares, portion);

            (, , totalBorrowAssets, totalBorrowShares) = _getAccruedMarketTotals(morpho, mp);

            uint256 repayAssets = SharesMathLib.toAssetsUp(
                repayShares,
                totalBorrowAssets,
                totalBorrowShares
            );
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function collectSupplies(
        ...
        for (uint256 i; i < mids.length; i++) {
            ...
            uint256 shares = MorphoMathLib.mulPortionRoundDown(p.supplyShares, portion);

            (totalSupplyAssets, totalSupplyShares, , ) = _getAccruedMarketTotals(morpho, mp);

            uint256 assets = SharesMathLib.toAssetsDown(
                shares,
                totalSupplyAssets,
                totalSupplyShares
            );
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function collectCollaterals(
        ...
        for (uint256 i; i < mids.length; i++) {
            ...
            amount = MorphoMathLib.mulPortionRoundDown(p.collateral, portion);

            plans[n++] = CollateralPlan({ id: mids[i], mp: mp, withdrawCollateral: amount });
        }
    ...
    function _getSupplyValue(
        ...
        uint256 assets = SharesMathLib.toAssetsDown(
            p.supplyShares,
            ms.totalSupplyAssets,
            ms.totalSupplyShares
        );
    ...
    function _getBorrowValue(
        ...
        uint256 assets = SharesMathLib.toAssetsUp(
            p.borrowShares,
            ms.totalBorrowAssets,
            ms.totalBorrowShares
        );
