  ...
  function afterTxGuard(
    ...
    slippageAccumulator.updateSlippageImpact(
      ...
      SlippageAccumulator.SwapData({
        ...
        srcAmount: intermediateSwapData.srcAmount - _getBalance(intermediateSwapData.srcAsset, poolLogic),

        // dstAmountDelta = currentDstBalance - previousDstBalance
        dstAmount: _getBalance(intermediateSwapData.dstAsset, poolLogic) - intermediateSwapData.dstAmount
      })
    );
