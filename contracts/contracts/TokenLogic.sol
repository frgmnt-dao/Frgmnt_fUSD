    ...
    UUPSUpgradeable
{
        ...
        whenNotPaused
    {
        ...
        averageMintTimestamp[msg.sender] =
            _updateAverageMintTimestamp(previousTs, fusdAmount, prevBalance);
     ...
     */
    function getExitRemainingCooldown(address user)
        external
        view
        returns (uint256)
    {
